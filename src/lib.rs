...
#[derive(Debug)]
pub struct ControlPanelProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ControlPanelProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ControlPanel processing");
    
    let mut processor = ControlPanelProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ControlPanelProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ControlPanelProcessor::new(false);
